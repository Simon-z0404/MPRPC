...
static void InitDefaultsscc_info_GetFriendListRespone_friend_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_GetFriendListRespone_friend_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_GetFriendListRespone_friend_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRequest, name_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRequest, pwd_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRespone, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRespone, result_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRespone, friendlist_),
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListRespone, success_),
};
...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "errcode\030\001 \001(\r\022\016\n\006errmsg\030\002 \001(\014\"=\n\024GetFrie"
  "ndListRequest\022\n\n\002id\030\001 \001(\r\022\014\n\004name\030\002 \001(\014\022"
  "\013\n\003pwd\030\003 \001(\014\"_\n\024GetFriendListRespone\022\"\n\006"
  "result\030\001 \001(\0132\022.fixbug.ResultCode\022\022\n\nfrie"
  "ndList\030\002 \003(\014\022\017\n\007success\030\003 \001(\0102_\n\020FriendS"
  "erviceRpc\022K\n\rGetFriendList\022\034.fixbug.GetF"
  "riendListRequest\032\034.fixbug.GetFriendListR"
  "esponeB\003\200\001\001b\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_friend_2eproto_sccs[3] = {
  ...
  &scc_info_GetFriendListRespone_friend_2eproto.base,
  &scc_info_ResultCode_friend_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_friend_2eproto = {
  &descriptor_table_friend_2eproto_initialized, descriptor_table_protodef_friend_2eproto, "friend.proto", 339,
...
void GetFriendListRespone::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListRespone_default_instance_._instance.get_mutable()->result_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class GetFriendListRespone::_Internal {
 public:
  static const ::fixbug::ResultCode& result(const GetFriendListRespone* msg);
};

const ::fixbug::ResultCode&
GetFriendListRespone::_Internal::result(const GetFriendListRespone* msg) {
  return *msg->result_;
}
...
void GetFriendListRespone::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendListRespone_friend_2eproto.base);
    ...
    case 0:
      GetFriendList(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::GetFriendListRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::fixbug::GetFriendListRespone*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& FriendServiceRpc::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::fixbug::GetFriendListRespone::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
